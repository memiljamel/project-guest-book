                                ...
                                <form class="contents w-auto h-auto p-0 m-0 relative" action="{{ route('staffs.destroy', $staff->id) }}" method="POST">
                                    ...
                                    <div class="inline-block w-auto h-auto p-0 m-0 relative">
                                        ...
                                        <div class="block w-auto h-auto p-0 m-0 relative">
                                            <a href="{{ route('staffs.edit', $staff->id) }}" class="block w-10 h-10 p-2 m-0 bg-transparent rounded-full text-black/[0.60] outline-none cursor-pointer align-middle transition duration-150 ease-in-out hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12] dark:text-white/[0.60] dark:hover:bg-white/[0.04] dark:active:bg-white/[0.10] dark:focus:bg-white/[0.12]" data-te-toggle="tooltip" title="Edit">
                                                <svg class="pointer-events-none w-full h-full fill-current" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                                    <path d="M0 0h24v24H0z" fill="none" />
